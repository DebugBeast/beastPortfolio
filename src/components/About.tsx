      ...
      <div className="container mx-auto px-6 relative">
        ...
        <div className="max-w-5xl mx-auto mb-16 text-center">
          <p className="text-base sm:text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
            Hey there! 👋 I'm DebugBeast, a passionate Web Developer and
            final-year IT student. I thrive on turning ideas into powerful,
            user-friendly web experiences. My tech journey is fueled by
            curiosity, continuous learning, and a love for solving real-world
            problems through clean, scalable code. Whether it's front-end
            finesse or back-end logic, I'm all about building impactful
