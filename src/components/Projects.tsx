...
const projects = [
  {
    title: 'FlowClock',
    description: 'A Smart & Minimal Stopwatch that helps you being productive. It includes break timers, motivational quotes, and background music support to keep you in the flow while tracking time.',
    image: '/assets/flowclock.webp',
    link: 'https://flowclock.vercel.app/',
    github: 'https://github.com/DebugBeast/flowclock',
    techStack: [
      techStacks.html,
      techStacks.CSS,
